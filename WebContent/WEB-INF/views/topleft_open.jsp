...
$("body").on("click","#usercenter,#usercenter2",function(){
	...
	<div id="jquery-accordion-menu" class="jquery-accordion-menu red downleft nano" style="z-index: 5;overflow-x:visible;">
		...
		<div class="jquery-accordion-menu-footer tooltipa1 notvisible" id="proAndser" style="cursor:pointer;" data-toggle="tooltip" data-placement="right" title="产品与服务">
			<img class="forrotate" src="img/icons/iconfont/arrowdown.png" style="position:relative;top:16px;"></img>&nbsp;&nbsp;
			
		</div>
		
		<div class="jquery-accordion-menu-footer tooltipa2" id="proAndser2" style="cursor:pointer;">
			<img class="forrotate" src="img/icons/iconfont/arrowdown.png" style="position:relative;top:16px;"></img>&nbsp;&nbsp;
		...
		<div class="jquery-accordion-menu-footer tooltipa2" id="usercenter2" style="cursor:pointer;">
			<img class="forrotate2" src="img/icons/iconfont/arrowdown.png" style="position:relative;top:16px;"></img>&nbsp;&nbsp;
