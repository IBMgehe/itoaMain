...
<script type="text/javascript">
	...
	function getVGnum() {
		if ($("#pvs9").val() == '' || $("#pvs9").val().split(',').length < 4) {
			...
			swal({
	            title: "",
	            text: "虚机当前挂载的Hdisk数量小于4，请至少挂载4块",
	            type: "warning",
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			<a href="getAllServers.do" title="IBM DB2" class="tip-bottom"><i
					...
					<div class="columnauto">
						<div class="mainmodule">
							...
							<div class="mainmodule" id="div1">
								<form action="toDb2NextPage.do?serId=${serId}&platform=${platform}&type=${ptype}&status=config" method="post" id="submits">
									<div class="form-horizontal processInfo">
										...
										<input type="hidden" id="db2archlogpv" name="db2archlogpv" /> 
...
<!--
										...
										<div class="control-group groupborder" id="divnfs1" style="display: none;">
											<div class="controls controls-mini" style="margin-left: 0.7%;">
												<span class="input140 mr20" style="width: 142px;">服务端IP地址1</span>
												<div class="inputb4" style="width: 20%;">
													<input type="text" name="nfsIP1" value="" style="width: 60%;" />
												</div>
												<span class="input140 mr20" style="width: 128px;">服务端共享目录1</span>
												<div class="inputb4" style="width: 20%;">
													<input type="text" name="nfsSPoint1" value="" style="width: 50%;" />
													<span class="ml5" style="color: #C0C0C0">(如 /home/nfs)</span>
												</div>
												<span class="input140 mr20" style="width: 128px;">客户端挂载点1</span>
												<div class="inputb4" style="width: 20%;">
													<input type="text" name="nfsCPoint1" value="" style="width: 55%;" />
