	...
	function checkMQSelect() {
		...
		$("input[name='servers']").each(function() {
		 ...
		 if (infoId.length != 1 ) 
		 {
			...
			{
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=mq&platform=aix";
			}
			else if(osId[0].toLowerCase().indexOf('windows')==0)
			{
				sweet("MQ不支持windows操作系统!","warning","确定");
				return;
			}
			else
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=mq&platform=linux";
		}
	}
</script>
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" class="current1">IBM MQ</a>
		</div>
