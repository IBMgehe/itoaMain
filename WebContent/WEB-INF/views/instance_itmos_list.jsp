...
<script  type="text/javascript">
	...
	function checkSelect() 
	{
		...
		}
		{
			...
			{
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=itmos&platform=aix";
			}
			else if(osId[0].toLowerCase().indexOf('windows')==0)
			{
				sweet("ITM OS Agent不支持windows操作系统!","warning","确定");
				return;
			}
			else
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=itmos&platform=linux";
		}
	}
</script>
</head>
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" class="current1">IBM OS Agent</a>
		</div>
