...
<script type="text/javascript">
					  	...
					  	swal({title: "",text:finalStringOut ,  type: type,confirmButtonText: "返回",confirmButtonColor: "rgb(174,222,244)"},
								function(isConfirm)
								{
									  if (isConfirm) 
									  {
										  ...
										  window.location.href = "getIBMAllInstance.do?ptype=mqcluster";
									  } 
								})
					}
	...
	function checkMQSelect() {
		...
		}  
		{
			...
			{
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=mqcluster&platform=aix";
			}
			else if(osId[0].toLowerCase().indexOf('windows')==0)
			{
				sweet("MQCluster不支持windows操作系统!","warning","确定");
				return;
			}else
				location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=mqcluster&platform=linux";
		}
	}
</script>
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" class="current1">IBM MQCluster</a>
		</div>
