...
//ajax 更新每个task的状态信息
	function giveTdColor(data)
	{
		...
		$('#logTable3 tbody tr').each(function(){
		  ...
		  //tdText.text(data[tdStep.html().trim()]);
		  //tdText.text(data[tdStep.html().trim()+tdStep_next.html().trim()]);
		  //alert(tdStep.html().trim() + "," +  tdText.html().trim());
			if (tdText.html().trim() == "成功") 
			{
				tdText.removeClass();
				tdText.addClass("bcg");
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			<a href="getLogInfo.do" class="current1"> <i class="icon-home"></i>历史执行日志
				...
				<div class="span12">
					<div class="columnauto">
						...
						<div id="logmsg" class="tabcontent tabnow">
							...
							<h5>详细任务执行状态：</h5>
							<table id="logTable3"
								class="table table-bordered  table-hover table-condensed no-search no-select"
