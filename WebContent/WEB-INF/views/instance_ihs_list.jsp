					  	...
					  	swal({title: "",text:finalStringOut ,  type: type,confirmButtonText: "返回",confirmButtonColor: "rgb(174,222,244)"},
								function(isConfirm)
								{
									  if (isConfirm) 
									  {
										  ...
										  window.location.href = "getIBMAllInstance.do?ptype=ihs";
									  } 
								})
					}
	...
	function checkIHSSelect() {
		...
		if (infoId.length != 1 ) 
		{
			...
			return;
			 ...
			 {
				 location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=ihs&platform=aix";
			 }
			 else if(osId[0].toLowerCase().indexOf('windows')==0)
			 {
				 sweet("IHS不支持windows操作系统!","warning","确定"); 
				 return;
			 }
			 else
				 location.href = "getInstanceDetial.do?serId=" + infoId + "&ptype=ihs&platform=linux";
		}
	}
</script>
</head>
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			<a href="getAllServers.do" class="current"><i class="icon-home"></i>实例一览</a>
			<a href="#" class="current1">IBM IHS</a>
		</div>
				...
				<div class="span12">
					<div class="widget-box collapsible">
						...
						<div id="collapseOne" class="collapse in">
							<div class="widget-content">所有IHS实例信息.</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="columnfoot" style="width: 93%; left: 5%;">
						<a class="btn btn-info fr btn-next" onclick="checkIHSSelect();">
